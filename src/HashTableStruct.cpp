...
CurveHashTableStruct::CurveHashTableStruct(int numOfHTs,int sz,int ampSize,int numDimension,int min,int max,int pointHasherWindow) :HashTableStruct(numOfHTs,sz) {
   CurveHasher **h; 
